...
| 7    | O planejamento dos resultados contém os itens necessários para a avaliação (objetivos, escopo, descrição do método de teste, etc)? | Conforme  | 1.0, 03/02/2025 | ![9](../../../assets/referenciasLista/entrega08/verificacaoResultados/pergunta7Resultados.png) BARBOSA, Simone Diniz Junqueira; SILVA, Bruno Santana da. Interação Humano-Computador. Rio de Janeiro: Elsevier, 2010. p. 343. |
